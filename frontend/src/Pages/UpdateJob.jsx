 ...
 {/* first row */}
  <div className='create-job-flex'>
        <div className='lg:w-1/2 w-full '>
            ...
            <input type="text" defaultValue={jobTitle} placeholder='Title of the job'
  ...
  <div className='create-job-flex'>
    ...
    <option value="Yearly">Yearly</option>
        ...
        <div className='lg:w-1/2 w-full '>
            ...
            <input type="text" placeholder='Ex: Hyderabad' defaultValue={jobLocation}
  ...
  <div className='lg:w-1/2 w-full '>
            ...
            <input type="date" placeholder='Ex: YYYY-MM-DD' defaultValue={postingDate}
