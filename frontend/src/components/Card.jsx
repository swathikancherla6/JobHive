    ...
    <section className='card'>
        ...
        <div >
            ...
            <div className='text-primary/70 text-base flex flex-wrap gap-2 mb-2'>
                ...
                <span className='flex items-center gap-1 ml-2'><FiClock/> {employmentType}</span>
                <span className='flex items-center gap-0 ml-2'><FaIndianRupeeSign/> {minPrice}-{maxPrice}k</span>
                <span className='flex items-center gap-1 ml-2'><FiCalendar/> {postingDate}</span>
            </div>
